  ...
  [[:licenses
   ...
   [:developers
    [:developer
     [:name "pink-gorilla"]]]
   [:scm
    [:url "https://github.com/pink-gorilla/devtools"]
    [:connection "scm:git:git://github.com/pink-gorilla/devtools.git"]
    [:developerConnection "scm:git:ssh://git@github.com/pink-gorilla/devtools.git"]]])
